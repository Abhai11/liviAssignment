...
- Whenever the server is restarted, any added services disappear - Done persisting services into DB
- There's no way to delete individual services - Added delete endpoint
- We want to be able to name services and remember when they were added - information visible on http://localhost:8080/service
- The HTTP poller is not implemented - implemented
